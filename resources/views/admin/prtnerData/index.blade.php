                ...
                <div class="tabs">
                    <div class="tab-content">
                        <div id="edit" class="tab-pane active">
                            <form class="p-3" action="{{ route('admin.partner-data.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="form-group col-md-2">
                                        <img src="{{ asset($data->image) }}" alt="" class="border" width="100">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        <iframe src="{{ asset($data->file) }}" frameborder="0"></iframe>
                                    </div>
                                </div>

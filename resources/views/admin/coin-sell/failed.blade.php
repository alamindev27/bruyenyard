                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-start align-items-center">
                                            ...
                                            <div>
                                                <span class="fw-bold d-block fw-bold">{{ $data->sellCoinWithUserRelation->name }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ route('admin.coinSell.status.update.delete', $data->id) }}" class="btn btn-sm btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>

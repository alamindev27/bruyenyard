    ...
    <section class="crypten-trade-area pt-190">
        <div class="item-1">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="crypten-trade-thumb">
                            <img src="{{ asset($presale->image) }}" alt="" style="border-radius: 30px;">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="crypten-trade-content">
                            <h3 class="title">{{ $presale->heading }}</h3>
                            <p>{{ $presale->text }}</p>

                            <div class="MuiContainer-root MuiContainer-maxWidthLg MuiBox-root ">
                                <div class="MuiBox-root css-13z5pxf">
                                    <div class="MuiBox-root css-agx226">
                                        <div class="MuiGrid-root MuiGrid-container css-920k2u">


                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 MuiBox-root css-1n88y7j"
                                                style="opacity: 1; transform: none;">
                                                <div class="MuiBox-root css-12mn81y">
                                                    <div class="MuiBox-root css-1ih4dy">
                                                        <div class="MuiBox-root css-504fyg"></div>
                                                    </div>
                                                    <div class="MuiBox-root css-0">{{ $presale->pre_sale }}%</div>
                                                </div>
                                                <p class="MuiTypography-root MuiTypography-body1 css-eer42b">Pre-Sale</p>
                                            </div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 MuiBox-root css-1n88y7j"
                                                style="opacity: 1; transform: none;">
                                                <div class="MuiBox-root css-12mn81y">
                                                    ...
                                                    <div class="MuiBox-root css-0">{{ $presale->bounties }}%</div>
                                                </div>
                                                <p class="MuiTypography-root MuiTypography-body1 css-eer42b">Bounties</p>
                                            </div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 MuiBox-root css-1n88y7j"
                                                style="opacity: 1; transform: none;">
                                                <div class="MuiBox-root css-12mn81y">
                                                    ...
                                                    <div class="MuiBox-root css-0">{{ $presale->liquidity_ool }}%</div>
                                                </div>
                                                <p class="MuiTypography-root MuiTypography-body1 css-eer42b">Liquidity Pool
                                                </p>
                                            </div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 MuiBox-root css-1n88y7j"
                                                style="opacity: 1; transform: none;">
                                                <div class="MuiBox-root css-12mn81y">
                                                    ...
                                                    <div class="MuiBox-root css-0">{{ $presale->team }}%</div>
                                                </div>
                                                <p class="MuiTypography-root MuiTypography-body1 css-eer42b">Team</p>
                                            </div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 MuiBox-root css-1n88y7j"
                                                style="opacity: 1; transform: none;">
                                                <div class="MuiBox-root css-12mn81y">
                                                    ...
                                                    <div class="MuiBox-root css-0">{{ $presale->advisors }}%</div>
                                                </div>
                                                <p class="MuiTypography-root MuiTypography-body1 css-eer42b">Advisors</p>
                                            </div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 MuiBox-root css-1n88y7j"
                                                style="opacity: 1; transform: none;">
                                                <div class="MuiBox-root css-12mn81y">
                                                    ...
                                                    <div class="MuiBox-root css-0">{{ $presale->marketing_and_bd }}%</div>
                                                </div>
                                                <p class="MuiTypography-root MuiTypography-body1 css-eer42b">Marketing
                                                </p>
                                            </div>
                                            <div class="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 MuiBox-root css-1n88y7j"
                                                style="opacity: 1; transform: none;">
                                                <div class="MuiBox-root css-12mn81y">
                                                    ...
                                                    <div class="MuiBox-root css-0">{{ $presale->pre_seed }}%</div>
                                                </div>
                                                <p class="MuiTypography-root MuiTypography-body1 css-eer42b">Pre-Seed</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="MuiBox-root css-y5jild">
                    <div class="MuiBox-root css-3q1abv" sx="[object Object]" data-projection-id="255"
                        style="opacity: 1; transform: none;">Pre-Sale Raise</div>
                    <div class="MuiTableContainer-root css-sfya7u">
                        <table class="MuiTable-root css-oitifm">
                            <tr class="MuiTableRow-root css-1vx9537" role="row" data-projection-id="256"
                                style="opacity: 1; transform: none;">
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-o1awyq">Token Allocation </td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">Allocation %</td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">Allocation #</td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">Token $</td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">Discount Price</td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">USD Value</td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">Buyer Limit (Tokens)</td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">Duration</td>
                                <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">Vesting</td>
                            </tr>
                            @foreach ($raises as $data)
                                <tr class="MuiTableRow-root css-27oabl" role="row" data-projection-id="258" style="opacity: 1; transform: none;">
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">{{ $data->token_allocation }}</td>
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">{{ $data->allocation_percentage }}%</td>
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">${{ number_format($data->allocation_amount) }} </td>
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">${{ $data->token }}</td>
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">{{ number_format($data->discount_price) }} %</td>
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp">${{ $data->USD_value }}</td>
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-m446mp" rowspan="8">Until Cap reached or Ended Early</td>
                                    <td class="MuiTableCell-root MuiTableCell-sizeMedium css-j4il3z" rowspan="8">4 Vested Stakes. Over a period of 4 months</td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
